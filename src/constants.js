...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript, React, Next.js, TypeScript these days.
      I've made a couple of projectsin that language. I also use Node.js, Express and Nest.js. Anyway regardless of the language, I just like programming.
      Here is my <a href="https://github.com/VladAntonov95" target="_blank">Github</a>!`,
  ...
  "sofa-table": `That's my sofa. I like to relax here and watch YouTube or Netflix. 
    I also like game programming tutorials on YouTube. Go sub to <a href="https://youtube.com/@jslegenddev" target="_blank">this channel</a>!
  ...
  resume: `This is my desk and on it is my <a href="./resume.pdf" target="_blank"> PDF resume</a> and my <a href="https://resume-five-rose.vercel.app/" target="_blank">website resume</a>. Contact me if you have any interesting job opportunities!`,
